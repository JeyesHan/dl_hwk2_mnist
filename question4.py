...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 200, kernel_size=5)	#1*28*28 -> 20*24*24->20*12*12
        self.conv2 = nn.Conv2d(200, 500, kernel_size=5)	#20*12*12 -> 50*8*8 -> 50*4*4
        self.conv3 = nn.Conv2d(500,1000,kernel_size=4)    #500*1*1
        self.conv4 = nn.Conv2d(1000,10,kernel_size=1)    #10*1*1
